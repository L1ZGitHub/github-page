...
Existing legal frameworks struggle with this. Product liability law assumes a manufacturer. Open-source licenses explicitly disclaim liability. The person who deployed the system may lack the technical sophistication to understand its failure modes. And the harm may cross jurisdictions, making enforcement even more complex. These questions sit squarely within the broader [alignment and safety challenges facing a multipolar world](/blog/ai-alignment-safety-in-a-multipolar-world).
