...
American frontier labs have invested heavily in alignment research, driven by a combination of genuine concern about advanced AI risks and the reputational necessity of demonstrating responsible development. The technical portfolio includes [Reinforcement Learning](/blog/finagent-and-beyond-multimodal-foundation-agents-for-trading) from Human Feedback (RLHF), Constitutional AI (Anthropic's approach of training models against explicit principles), red-teaming, and increasingly sophisticated [evaluation frameworks](/blog/llm-evaluation-frameworks-beyond-perplexity) for dangerous capabilities.
...
Chinese labs are investing more heavily in structured output control: ensuring that model outputs conform to specific requirements through a combination of training-time constraints, inference-time filtering, and [retrieval-augmented generation](/blog/retrieval-augmented-generation-a-complete-guide) with curated knowledge bases. This approach is less concerned with the model's "internal alignment" and more concerned with observable output compliance. It is pragmatic and effective for its stated goals.
...
- [Building Custom Tokenizers for Domain-Specific NLP](/blog/building-custom-tokenizers-for-domain-specific-nlp)
