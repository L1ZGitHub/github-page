...
The convergence of large language models, autonomous agent frameworks, and decentralized finance has created a new class of market participant: the AI trading agent. The architectural building blocks of [multi-agent systems](/blog/building-a-multi-agent-ai-system) are now being deployed in one of the highest-stakes environments in software.
...
LLM-powered agents also process natural language at scale, parsing news, social media, and earnings calls to generate trading signals. These [multimodal approaches to combining different data sources](/blog/multimodal-ai-combining-vision-and-language-models) give agents a broader market view than purely numerical systems.
...
Agents can be designed, or inadvertently evolve, to engage in wash trading, spoofing, or front-running. In a permissionless system with no central authority, distinguishing legitimate strategies from manipulation is hard. The attack surface of an agent managing real money is considerable, and adversarial agents can [exploit vulnerabilities](/blog/ai-security-how-agents-like-openclaw-can-be-exploited) to trade against others.

### Regulatory Gaps

Most financial regulation was written for human participants. Autonomous agents in DeFi exist in a gray zone. Who is liable when an agent causes a market disruption? Do agents need KYC compliance? How do you regulate a system making thousands of opaque decisions per day? Regulators in the US, EU, and Asia are actively working on frameworks, but the technology moves faster than the rules. The [risks around information contamination](/blog/ai-agents-in-finance-mnpi-risks-and-cross-deal-contamination) add another layer of complexity.
