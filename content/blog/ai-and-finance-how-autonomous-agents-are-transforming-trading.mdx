...
The convergence of [large language models](/blog/data-privacy-in-the-age-of-large-language-models), [autonomous agent](/blog/openclaw-attack-surface-case-study-autonomous-agents) frameworks, and decentralized finance has created a new class of market participant: the AI trading agent. If you have followed my articles on [Building a Multi-Agent AI System](/blog/building-a-multi-agent-ai-system) or [Building AI Agents with LangChain and LangGraph](/blog/building-ai-agents-with-langchain-and-langgraph), you have seen the architectural building blocks. Now those blocks are being deployed in one of the highest-stakes environments imaginable.
...
In a multi-agent market, some agents are specifically designed to exploit others, detecting patterns and trading against them. This connects to the security considerations I discussed in AI Security: How [Agents Like OpenClaw](/blog/ai-security-how-agents-like-openclaw-can-be-exploited) Can Be Exploited. The attack surface of an agent managing real money is considerable.
