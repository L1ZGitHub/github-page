...
- [Vector search](/blog/understanding-vector-databases) (dense retrieval over an embedding index).
...
- **Quality metrics**: user feedback, click-through, human evals. [Evaluating RAG system performance](/blog/evaluating-rag-system-performance) is a good starting point if your pipeline serves retrieval-augmented answers.
...
A solid [CI/CD pipeline](/blog/cicd-pipelines-for-machine-learning-projects) helps here, so that model updates and code changes flow through automated tests before reaching production.
...
- Clear places to plug in [monitoring](/blog/monitoring-ml-models-in-production) and privacy-preserving steps.
