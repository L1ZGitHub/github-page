...
- Protect user data, as in *[Data Privacy in the Age of Large Language Models](/blog/data-privacy-in-the-age-of-large-language-models)*.
...
These metrics echo the frameworks described in *Retrieval-Augmented Generation: A Complete Guide* and *[Semantic Search vs Keyword Search: When to Use What](/blog/semantic-search-vs-keyword-search-when-to-use-what)*.

### 4. Privacy and security checks

If you work with sensitive data, your CI/CD pipeline must help enforce privacy commitments, as discussed in *Introduction to Differential Privacy for NLP* and *[Privacy-Preserving NLP: Protecting Sensitive Data in Language Models](/blog/privacy-preserving-nlp)*.
