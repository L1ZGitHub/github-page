...
4. **Infrastructure** - [vector databases](/blog/understanding-vector-databases), GPUs, workers, API gateways.
...
This follows the same principles used when [evaluating RAG system performance](/blog/evaluating-rag-system-performance): define metrics upfront, automate measurement, and fail on regressions.
...
Once CI passes, you want a reliable way to ship models and services. A common baseline is [serving behind FastAPI in Docker](/blog/deploying-ml-models-with-fastapi-and-docker), then layering on artifact versioning and staged rollouts.
...
When dealing with RAG or [multimodal](/blog/multimodal-ai-combining-vision-and-language-models) pipelines, there are extra moving parts:
