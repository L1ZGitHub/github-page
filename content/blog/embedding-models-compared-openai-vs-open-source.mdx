...
If you have read my guides on [Retrieval-Augmented Generation](/blog/retrieval-augmented-generation-a-complete-guide) and [Building Production-Ready RAG Systems](/blog/building-production-ready-rag-systems), you know embeddings sit in the critical path of:
...
OpenAI offers options to avoid training on your data, but regulatory or contractual requirements may still forbid sending data off-prem. In my article on [Privacy-Preserving NLP](/blog/privacy-preserving-nlp) I go deeper into these constraints and typical threat models.
...
You can choose 384, 768, 1024, 2048 dimensional models depending on your latency/accuracy tradeoff and how it works with your vector database (see [Understanding Vector Databases](/blog/understanding-vector-databases) for more on storage and indexing implications).
...
If you have read [Chunking Strategies for RAG Pipelines](/blog/chunking-strategies-for-rag-pipelines), you know that evaluation must reflect the full retrieval context. Same applies here.
...
- [Model Context Protocol: Connecting LLMs to External Tools](/blog/model-context-protocol-connecting-llms-to-external-tools)
