...
- You need the model to answer questions about specific documents (see [understanding vector databases](/blog/understanding-vector-databases) for the retrieval side)
...
In many production scenarios, the best approach is to fine-tune a model for your domain and style, then layer RAG on top for specific knowledge retrieval. Measuring the impact of each layer requires solid [evaluation of your RAG pipeline](/blog/evaluating-rag-system-performance). This gives you a model that speaks your language and can reference your data.
...
- **Human evaluation**: The gold standard, especially for open-ended generation (more on this in [LLM evaluation frameworks](/blog/llm-evaluation-frameworks-beyond-perplexity))
...
5. **Ignoring the base model**: Always compare against the un-fine-tuned model. Sometimes [prompt engineering](/blog/prompt-engineering-best-practices-for-production) alone is sufficient.
