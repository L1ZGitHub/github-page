...
If you read [Retrieval-Augmented Generation: A Complete Guide](/blog/retrieval-augmented-generation-a-complete-guide) and Building Production-Ready RAG Systems, you know that improving retrieval quality and context formatting usually gives the highest ROI.
...
If you are fine-tuning on private data (support conversations, medical notes, internal documents), revisit topics from [Data Privacy in the Age of Large Language Models](/blog/data-privacy-in-the-age-of-large-language-models) and [Privacy-Preserving NLP: Protecting Sensitive Data in Language Models](/blog/privacy-preserving-nlp).
...
If you already have a RAG system similar to what I describe in Building a Multi-Agent AI System or [Knowledge Graphs Meet LLMs: Structured RAG Architectures](/blog/knowledge-graphs-meet-llms-structured-rag-architectures), the best place to insert LoRA is usually the final answer generation step.
...
- [Fine-Tuning LLMs on Custom Data: A Practical Guide](/blog/fine-tuning-llms-custom-data)
