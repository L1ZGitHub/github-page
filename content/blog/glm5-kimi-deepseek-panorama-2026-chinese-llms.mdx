...
K2.5 uses a 64-expert MoE architecture with approximately 200B active parameters per token. The model supports a 128K context window natively and includes a vision encoder for [multimodal inputs](/blog/multimodal-ai-combining-vision-and-language-models), which Moonshot AI positions as useful for understanding UIs, diagrams, and documentation screenshots during coding workflows.
...
- **[RAG and retrieval-heavy pipelines](/blog/evaluating-rag-system-performance)**: DeepSeek V3 or Qwen-2.5 (both handle long contexts well with manageable inference costs)
