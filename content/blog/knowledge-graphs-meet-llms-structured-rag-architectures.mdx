...
- A [vector database](/blog/understanding-vector-databases) for embedding storage and similarity search
...
Extend your [RAG evaluation metrics](/blog/evaluating-rag-system-performance) to structured RAG:
...
- **[Agentic systems](/blog/agentic-rag-the-next-evolution)**: agents can use the graph as a world model, planning over entities and relations instead of raw text
