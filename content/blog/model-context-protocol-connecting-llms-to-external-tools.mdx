...
- RAG answer style
- Privacy-aware redaction (see [Data Privacy in the Age of Large Language Models](/blog/data-privacy-in-the-age-of-large-language-models))
...
- Retrieval tools
  ...
  - `sparse_search` using BM25 or keyword (see [Hybrid Search: Combining Dense and Sparse Retrieval](/blog/hybrid-search-combining-dense-and-sparse-retrieval))
- Reranking tools
...
If you are already comfortable with concepts from Understanding Transformer Architectures and [Building AI Agents with LangChain and LangGraph](/blog/building-ai-agents-with-langchain-and-langgraph), you are well positioned. MCP is less about a new theoretical idea and more about cleaning up the messy edges between LLMs and the rest of your stack.
