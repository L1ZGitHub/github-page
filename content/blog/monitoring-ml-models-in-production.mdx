...
If you have seen *[Embedding Models Compared: OpenAI vs Open-Source](/blog/embedding-models-compared-openai-vs-open-source)* or *[Hybrid Search: Combining Dense and Sparse Retrieval](/blog/hybrid-search-combining-dense-and-sparse-retrieval)*, you know embeddings change how we represent text.
...
Low similarity over time tells you your model is seeing qualitatively new queries. This ties directly to topics I discussed in *[Semantic Search vs Keyword Search: When to Use What](/blog/semantic-search-vs-keyword-search-when-to-use-what)*.
...
From *[Data Privacy in the Age of Large Language Models](/blog/data-privacy-in-the-age-of-large-language-models)* and *[Privacy-Preserving NLP: Protecting Sensitive Data in Language Models](/blog/privacy-preserving-nlp)*, you know that you must treat logs as sensitive data.
