...
The first design decision is how to assign roles to agents. In my earlier article on *Building a Multi-Agent AI System*, I covered the basics of when multi-agent setups make sense. Here, I want to go deeper into how you assign different LLMs to different roles.
...
In practice, I recommend starting with hub-and-spoke, moving to pipeline for well-understood workflows, and only using mesh when you have the monitoring infrastructure to support it. Which brings us to the topic I covered in *Monitoring ML Models in Production*, applied here at the multi-agent level.
...
Multi-agent multi-LLM systems are distributed systems, and they need to be treated as such. Every lesson from *CI/CD Pipelines for Machine Learning Projects* and *Monitoring ML Models in Production* applies here, multiplied by the number of agents.
