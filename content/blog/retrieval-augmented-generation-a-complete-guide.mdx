...
1. Store your knowledge in a searchable format (usually vectors in a [vector database](/blog/understanding-vector-databases))
...
- **No evaluation**: shipping without test questions and acceptance criteria. Having a proper [evaluation framework](/blog/evaluating-rag-system-performance) catches these issues early.
...
From there, you can explore more advanced variations like [multi-hop retrieval with agentic RAG](/blog/agentic-rag-the-next-evolution), tool-augmented agents, or combining vision and language in [multimodal AI](/blog/multimodal-ai-combining-vision-and-language-models) pipelines.
