...
In Embedding Models Compared: OpenAI vs Open-Source I covered quality trade-offs. At millions of documents you must also think about:
...
Once you pass a few hundred thousand documents, naive vector storage will hurt you. Understanding Vector Databases: A Beginner's Guide is a good foundation, but at this scale we need to think about layout and sharding.
...
At millions of documents across organizations, privacy concerns are unavoidable. The posts Data Privacy in the Age of Large Language Models and Privacy-Preserving NLP: Protecting Sensitive Data in Language Models cover the theory.
