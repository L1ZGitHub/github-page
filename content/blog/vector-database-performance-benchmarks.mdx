...
Before talking about numbers, we need clarity on *what* is being measured. For [vector databases](/blog/understanding-vector-databases), I focus on three dimensions:
...
The [embedding model](/blog/embedding-models-compared-openai-vs-open-source) affects:
...
Vector search latency is just one piece of your total pipeline. In a [production RAG system scaled to millions of documents](/blog/scaling-rag-systems-to-millions-of-documents), retrieval, ranking, and generation all contribute.
